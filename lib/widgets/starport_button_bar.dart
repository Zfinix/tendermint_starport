...
class StarportButtonBar extends StatelessWidget {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          Expanded(
            child:
                CosmosElevatedButton(text: 'Receive', onTap: onReceivePressed),
          ),
          SizedBox(
            width: CosmosTheme.of(context).spacingL,
          ),
          Expanded(
            child: CosmosElevatedButton(text: 'Send', onTap: onSendPressed),
          ),
        ],
      ),
    );
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(
          ObjectFlagProperty<VoidCallback>.has('onSendPressed', onSendPressed))
